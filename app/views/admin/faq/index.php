...
<style>
    ...
    /* Style cho Thanh tiêu đề (Header Bar) giống Hình 1 */
    .tz-header-bar {
        background: white;
        padding: 20px 30px;
        border-radius: 20px;
        border-left: 6px solid #007bff; /* Viền xanh đặc trưng */
        display: flex;
    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="tz-header-bar shadow-sm mb-4">
            <h3 class="fw-bold m-0 text-dark">
                <i class="fas fa-question-circle me-3 text-primary"></i>Hệ thống Quản lý FAQ
            </h3>
            <button class="btn btn-primary fw-bold px-4 rounded-3 shadow-sm">
                        ...
                        <?php if(!empty($faqs)): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="public_entry.php?url=users&tab=faq-delete&id=<?= $f['f_id'] ?>" class="btn btn-sm btn-danger px-2 shadow-sm" onclick="return confirm('Xóa câu hỏi này?')">
