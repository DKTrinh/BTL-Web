...
?>
<style>
    /* 1. SIDEBAR: Loại bỏ gạch ngang, đồng bộ hoàn toàn với About Edit */
    .tz-sidebar { 
    ...
    .sidebar-link.active { 
        background-color: #1e6f5c !important; /* Màu xanh đặc trưng đồng bộ */
        color: white !important; 
        font-weight: 700; 
        box-shadow: 0 4px 10px rgba(0,0,0,0.2);
    }
    
    /* 2. HEADER BAR: Bo góc 20px và Shadow nhẹ */
    .tz-header-bar {
        background: white;
        padding: 15px 20px;
        border-radius: 15px;
    ...
    /* Viền màu theo từng Tab để phân biệt */
    .user-border { border-left: 6px solid #007bff; }
    .faq-border { border-left: 6px solid #28a745; }
</style>

<div class="d-flex flex-column flex-lg-row" style="background-color: #f4f6fa; min-height: 100vh;">
    
    <div class="tz-sidebar shadow-lg">
        <h5 class="text-info fw-bold mb-4 text-center mt-2">
    ...
    <div class="flex-grow-1 p-3 p-md-4">
        ...
        <?php if($current_tab == 'users'): ?>
            <div class="tz-header-bar user-border shadow-sm mb-4">
                            ...
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-bold small"><?= htmlspecialchars($u['fullname']) ?></div>
        ...
        <?php elseif($current_tab == 'faq'): ?>
            <div class="tz-header-bar faq-border shadow-sm mb-4">
                ...
                <button class="btn btn-success fw-bold px-4 rounded-3 w-100 w-sm-auto shadow-sm">
