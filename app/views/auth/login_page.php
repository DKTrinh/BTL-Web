            ...
            <div class="auth-card row g-0">
                <div class="col-md-6 auth-left d-flex flex-column justify-content-between">
                    <div class="auth-left-content">
                        ...
                        <h1 class="fw-bold display-5 mb-4">Hello,<br>welcome!</h1>
                        <p class="mb-5 text-white-50 small">Advanced emission control systems for industrial operations worldwide.</p>
                ...
                <div class="col-md-6 auth-right">
                    ...
                    <!-- Đảm bảo action này trỏ đúng nhánh login để tránh rẽ bừa bãi[cite: 16] -->
                    <!-- Trong thẻ <form> của login_page -->
                    <form action="?url=login" method="POST"> <!-- Điều hướng đúng nhánh[cite: 16] -->
                        <!-- DÙNG CSRFHELPER Ở ĐÂY[cite: 12, 16] -->
                        ...
                        <a href="?url=register" class="btn-outline-custom mt-3">Sign up</a> <!-- Rẽ sang register[cite: 16] -->
                    </form>
                </div>
            </div>
        </div>
